package com.nainiu192141.config;
...
/**
 * Created by xfx on 2021/3/6 22:49
 */
@Slf4j
@Configuration
public class ShardingsphereConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource1.setUrl("jdbc:mysql://localhost:3308/kimmking?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        dataSource2.setUrl("jdbc:mysql://localhost:3309/kimmking?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
