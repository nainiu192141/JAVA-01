...
public class HttpOutboundHandler {
    ...
    public void handle(FullHttpRequest fullRequest, ChannelHandlerContext ctx,HttpRequestFilter httpRequestFilter) {
...
//            System.out.println(body.length);
            ...
            response.headers().set("mao",fullRequest.headers().get("mao"));
