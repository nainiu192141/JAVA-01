...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, String backServer) {
        this.port=port;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .handler(new LoggingHandler(String.valueOf(LogLevel.INFO))).childHandler(new HttpInboundInitializer(this.backServer));
