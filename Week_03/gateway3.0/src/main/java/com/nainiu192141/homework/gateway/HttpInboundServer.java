...
/**
 * Created by xfx on 2021/1/25 19:25
 * @author 86134
 */
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, List<String> backServers) {
        this.port=port;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .handler(new LoggingHandler(String.valueOf(LogLevel.INFO))).childHandler(new HttpInboundInitializer(this.backServers));
